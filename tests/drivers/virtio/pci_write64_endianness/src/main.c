...
static uint8_t bar1[TEST_PAGE_SIZE] __aligned(TEST_PAGE_SIZE);
static uint8_t bar2[TEST_PAGE_SIZE] __aligned(TEST_PAGE_SIZE);
...
static void before(void *fixture)
{
	...
	/* Keep offset and length zero so this test is independent from capability-endian fixes. */
